---
agent: agent
description: "보안 취약점 검토 및 수정"
---

릴리즈 전 또는 Sprint 종료 전 보안 취약점을 검토하고 수정한다.
...
| 항목 | 체크 |
|------|------|
| npm audit | 취약점 있는 패키지 업데이트 |
| 버전 고정 | package-lock.json 커밋 |
| 미사용 의존성 | 제거 |
...
1. 코드 내 하드코딩된 시크릿 검색
2. SQL/명령어 인젝션 패턴 검색
3. 위험한 함수 사용 확인 (eval, innerHTML 등)
4. 취약점 목록 작성
...
```text
/docs/current_sprint/SECURITY_MMDDNN.md
```
